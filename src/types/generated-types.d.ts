...
type VideoFragment = { __typename: 'VideoRecord', description: string, createdAt: string, file: { __typename?: 'VideoField', url: string, thumbnailUrl: string } };

type LeaderShipVideosFragment = { __typename?: 'ThoughtLeadershipPageRecord', videosHeading: string, videosArchiveButton?: { __typename: 'PageLinkRecord', id: string, linkText: string, page: { __typename: 'AboutPageRecord', slug: string } | { __typename: 'ArchivePageRecord', slug: string } | { __typename: 'ArticlesPageRecord', slug: string } | { __typename: 'CoachCategoryRecord', slug: string } | { __typename: 'ContactPageRecord', slug: string } | { __typename: 'HomePageRecord' } | { __typename: 'ThoughtLeadershipPageRecord', slug: string } } | null, videoItemsOverrides: Array<{ __typename: 'VideoRecord', description: string, createdAt: string, file: { __typename?: 'VideoField', url: string, thumbnailUrl: string } }> };
