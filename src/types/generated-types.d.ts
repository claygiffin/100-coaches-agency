...
type FormModelOnSubmitField = CreateActiveCampaignContactActionRecord | OpenDocumentActionRecord | SendEmailActionRecord;
...
type FormFragment = { __typename: 'FormRecord', id: string, formName: string, submitButtonText: string, formFields: Array<{ __typename: 'FormSelectFieldRecord', id: string, label: string, required?: boolean | null, width: string, options: Array<{ __typename?: 'FormSelectOptionRecord', id: string, value: string }> } | { __typename: 'FormTextAreaRecord', id: string, label: string, required?: boolean | null } | { __typename: 'FormTextFieldRecord', id: string, label: string, fieldType: string, isInternational?: boolean | null, width: string, required?: boolean | null }>, successMessage: { __typename?: 'FormModelSuccessMessageField', value: unknown }, onSubmit: Array<{ __typename: 'CreateActiveCampaignContactActionRecord', updateIfExists?: boolean | null } | { __typename: 'OpenDocumentActionRecord', document: { __typename?: 'FileField', filename: string, id: string, url: string } } | { __typename: 'SendEmailActionRecord', recipients: string }> };
