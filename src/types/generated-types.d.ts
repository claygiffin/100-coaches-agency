...
type AccordionItemModelBodyField = {
  __typename?: 'AccordionItemModelBodyField';
  blocks: Array<Scalars['String']['output']>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
...
type AccordionItemRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  body: AccordionItemModelBodyField;
  createdAt: Scalars['DateTime']['output'];
...
/** Block of type Accordion Item (accordion_item) */
type AccordionItemRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Block of type Accordion (accordion) */
type AccordionRecord = RecordInterface & {
...
/** Block of type Accordion (accordion) */
type AccordionRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type AdvisorsPageRecord = RecordInterface & {
  ...
  aboutHeading: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  howBody?: Maybe<AdvisorsPageModelHowBodyField>;
  howDetails: Array<TitleDescriptionRecord>;
  howHeading: Scalars['String']['output'];
...
type BioSectionModelBodyBlocksField = AccordionRecord | ButtonRecord | LinkListRecord;

type BioSectionModelBodyField = {
  __typename?: 'BioSectionModelBodyField';
  blocks: Array<BioSectionModelBodyBlocksField>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
};

/** Block of type Bio Section (bio_section) */
type BioSectionRecord = RecordInterface & {
  __typename?: 'BioSectionRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  body: BioSectionModelBodyField;
  colorScheme: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  heading: Scalars['String']['output'];
  headshot: ImageFileField;
  id: Scalars['ItemId']['output'];
...
/** Block of type Bio Section (bio_section) */
type BioSectionRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type ContentSectionModelPullQuoteField = {
  __typename?: 'ContentSectionModelPullQuoteField';
  blocks: Array<Scalars['String']['output']>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
...
type ContentSectionModelSubheadingField = {
  __typename?: 'ContentSectionModelSubheadingField';
  blocks: Array<Scalars['String']['output']>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
...
/** Block of type Content Section (content_section) */
type ContentSectionRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  body: ContentSectionModelBodyField;
  colorScheme: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  heading: Scalars['String']['output'];
  id: Scalars['ItemId']['output'];
...
/** Block of type Content Section (content_section) */
type ContentSectionRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Record of type Interior Page (interior_page) */
type InteriorPageRecord = RecordInterface & {
  __typename?: 'InteriorPageRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Record of type Interior Page (interior_page) */
type InteriorPageRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type LinkListRecord = RecordInterface & {
  ...
  heading?: Maybe<Scalars['String']['output']>;
  id: Scalars['ItemId']['output'];
  links: Array<LinkListModelLinksField>;
  updatedAt: Scalars['DateTime']['output'];
};


/** Block of type Link List (link_list) */
type LinkListRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type MediaCarouselRecord = RecordInterface & {
  ...
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ItemId']['output'];
  media: Array<MediaCarouselModelMediaField>;
  updatedAt: Scalars['DateTime']['output'];
};
...
type PageHeroRecord = RecordInterface & {
...
/** Block of type Page Hero (page_hero) */
type PageHeroRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type Query = {
  ...
  /** Returns meta information regarding a record collection */
  _allInteriorPagesMeta: CollectionMetadata;
  /** Returns meta information regarding a record collection */
  ...
  /** Returns a collection of records */
  allInteriorPages: Array<InteriorPageRecord>;
  /** Returns a collection of records */
  ...
  /** Returns a specific record */
  interiorPage?: Maybe<InteriorPageRecord>;
  /** Returns the single instance record */
  nav?: Maybe<NavRecord>;
  /** Returns a specific record */
...
/** The query root for this schema */
type Query_allInteriorPagesMetaArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<InteriorPageModelFilter>;
  locale?: InputMaybe<SiteLocale>;
};
...
/** The query root for this schema */
type QueryallInteriorPagesArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<InteriorPageModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<InteriorPageModelOrderBy>>>;
  skip?: InputMaybe<Scalars['IntType']['input']>;
};
...
type SectionDividerRecord = RecordInterface & {
...
/** Block of type Section Divider (section_divider) */
type SectionDividerRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type HomePageQuery = { __typename?: 'Query', homePage?: { __typename?: 'HomePageRecord', heroHeading1: string, heroHeading2: string, introHeading?: string | null, promiseHeading: string, marshallHeading?: string | null, resultsHeading?: string | null, contactHeading?: string | null, companiesSection: { __typename: 'CompaniesSectionRecord', id: string, heading?: string | null, companies: Array<{ __typename: 'CompanyRecord', id: string, name: string, icon: { __typename?: 'FileField', format: string, url: string, width?: number | null, height?: number | null, alt?: string | null, responsiveImage?: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } | null } }> }, coachesSection: { __typename: 'HomeCoachesSectionRecord', id: string, heading?: string | null, body?: { __typename?: 'HomeCoachesSectionModelBodyField', value: unknown } | null, cta?:
    ...
    , marshallBody?: { __typename?: 'HomePageModelMarshallBodyField', value: unknown } | null, marshallCta?:
      | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
      | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
      | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
          | { __typename: 'AdvisorsPageRecord', slug: string }
     ...
     | null, marshallQuote?: { __typename?: 'QuoteRecord', attribution?: string | null, quote?: { __typename?: 'QuoteModelQuoteField', value: unknown } | null } | null, marshallImage?: { __typename?: 'FileField', responsiveImage?: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } | null } | null, resultsBody?: { __typename?: 'HomePageModelResultsBodyField', value: unknown } | null, contactBody?: { __typename?: 'HomePageModelContactBodyField', value: unknown } | null, contactLink?: { __typename: 'PageLinkRecord', id: string, linkText: string, page:
        ...
        | { __typename: 'FormSelectFieldRecord', id: string, label: string, required?: boolean | null, width: string, options: Array<{ __typename?: 'FormSelectOptionRecord', id: string, value: string }> }
        | { __typename: 'FormTextAreaRecord', id: string, label: string, required?: boolean | null }
        | { __typename: 'FormTextFieldRecord', id: string, label: string, fieldType: string, isInternational?: boolean | null, width: string, required?: boolean | null }
      >, successMessage: { __typename?: 'FormModelSuccessMessageField', value: unknown }, onSubmit: Array<
        | { __typename: 'CreateHubspotContactActionRecord' }
        | { __typename: 'OpenDocumentActionRecord', document: { __typename?: 'FileField', filename: string, id: string, url: string } }
...
type AllInteriorPageQuery = { __typename?: 'Query', allInteriorPages: Array<{ __typename?: 'InteriorPageRecord', slug: string }> };
...
type InteriorPageQuery = { __typename?: 'Query', interiorPage?: { __typename?: 'InteriorPageRecord', hero: { __typename: 'PageHeroRecord', id: string, heading: string, backgroundImage: { __typename?: 'ImageFileField', responsiveImage: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null }, focalPoint: { __typename?: 'focalPoint', x: number, y: number } } }, content: Array<
      | { __typename: 'BioSectionRecord', id: string, layout: string, colorScheme: string, heading: string, title?: string | null, body: { __typename?: 'BioSectionModelBodyField', value: unknown, blocks: Array<
      ...
      | { __typename: 'MediaSectionRecord', id: string, colorScheme: string, mediaCarousel: { __typename: 'MediaCarouselRecord', id: string, media: Array<
            ...
            | { __typename: 'InternalVideoRecord', id: string, video: { __typename: 'VideoFileField', id: string, video: { __typename?: 'UploadVideoField', muxPlaybackId: string, title?: string | null, width: number, height: number, thumbnailUrl: string } } }
          > } }
      | { __typename: 'SectionDividerRecord', id: string, heading: string }
...
type ArticleModalQuery = { __typename?: 'Query', article?: { __typename: 'ArticleRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, showInThoughtLeadership?: boolean | null, slug: string, createdAt?: string | null, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, body: { __typename?: 'ArticleModelBodyField', value: unknown, blocks: Array<
        ...
        | { __typename: 'ExternalVideoRecord', id: string, createdAt?: string | null, video: { __typename: 'VideoField', url: string, thumbnailUrl: string, title: string, width: number, height: number } }
        | { __typename: 'HubspotFormRecord', id: string, portalId: string, formId: string, region: string, createdAt?: string | null }
        ...
        | { __typename: 'InternalVideoRecord', id: string, createdAt?: string | null, video: { __typename: 'VideoFileField', id: string, video: { __typename?: 'UploadVideoField', muxPlaybackId: string, title?: string | null, width: number, height: number, thumbnailUrl: string } } }
      > }, ctaButton?:
      | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
      | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
          | { __typename: 'AdvisorsPageRecord', slug: string }
...
type NewsletterModalQuery = { __typename?: 'Query', newsletter?: { __typename: 'NewsletterRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, body: { __typename?: 'NewsletterModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type VideoModalQuery = { __typename?: 'Query', video?: { __typename: 'VideoRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, body: { __typename?: 'VideoModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type ArchivePageQuery = { __typename?: 'Query', archivePage?: { __typename?: 'ArchivePageRecord', archiveHeading: string, slug: string, archiveBackLink: { __typename: 'PageLinkRecord', id: string, linkText: string, page:
     ...
     | null, thumbnail: { __typename?: 'ImageFileField', alt?: string | null, title?: string | null, responsiveImage: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null }, focalPoint: { __typename?: 'focalPoint', x: number, y: number } }, _seoMetaTags: Array<{ __typename?: 'Tag', tag: string }> }>, allNewsletters: Array<{ __typename: 'NewsletterRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, body: { __typename?: 'NewsletterModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type ArticlePageQuery = { __typename?: 'Query', article?: { __typename: 'ArticleRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, showInThoughtLeadership?: boolean | null, slug: string, createdAt?: string | null, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, body: { __typename?: 'ArticleModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type ArticlesPageQuery = { __typename?: 'Query', articlesPage?: { __typename?: 'ArticlesPageRecord', pageHeading?: string | null, slug: string, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }> } | null, articles: Array<{ __typename: 'ArticleRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, showInThoughtLeadership?: boolean | null, slug: string, createdAt?: string | null, body: { __typename?: 'ArticleModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type ContactPageQuery = { __typename?: 'Query', contactPage?: { __typename?: 'ContactPageRecord', heading?: string | null, intro?: { __typename?: 'ContactPageModelIntroField', value: unknown } | null, form:
      | { __typename: 'FormRecord', id: string, formName: string, submitButtonText: string, formFields: Array<
          | { __typename: 'FormSelectFieldRecord', id: string, label: string, required?: boolean | null, width: string, options: Array<{ __typename?: 'FormSelectOptionRecord', id: string, value: string }> }
          | { __typename: 'FormTextAreaRecord', id: string, label: string, required?: boolean | null }
          | { __typename: 'FormTextFieldRecord', id: string, label: string, fieldType: string, isInternational?: boolean | null, width: string, required?: boolean | null }
        >, successMessage: { __typename?: 'FormModelSuccessMessageField', value: unknown }, onSubmit: Array<
...
type RootLayoutQuery = { __typename?: 'Query', alertBar?: { __typename: 'AlertBarRecord', id: string, isActive?: boolean | null, alertText?: { __typename?: 'AlertBarModelAlertTextField', value: unknown } | null, link?:
      | { __typename: 'ArticleLinkRecord', id: string, linkText: string, article: { __typename: 'ArticleRecord', slug: string } }
      | { __typename: 'DocumentLinkRecord', id: string, linkText: string, document: { __typename?: 'FileField', filename: string, id: string, url: string } }
      | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
      | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
     ...
     | null } | null, nav?: { __typename: 'NavRecord', id: string, links: Array<
      | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
      | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
      | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
      | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
    ...
    >, button?:
     ...
     | null } | null, allCoachCategories: Array<{ __typename: 'CoachCategoryRecord', id: string, categoryName: string, categoryNameFull?: string | null, description: string, categorySlug: string }> };
...
type NewsletterPageQuery = { __typename?: 'Query', newsletter?: { __typename: 'NewsletterRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, _seoMetaTags: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, body: { __typename?: 'NewsletterModelBodyField', value: unknown, blocks: Array<
        | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
        | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
            | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
            | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type AllVideoPageQueryVariables = Exact<{ [key: string]: never; }>;


type AllVideoPageQuery = { __typename?: 'Query', allVideos: Array<{ __typename?: 'VideoRecord', slug: string }> };
...
type AlertBarFragment = { __typename: 'AlertBarRecord', id: string, isActive?: boolean | null, alertText?: { __typename?: 'AlertBarModelAlertTextField', value: unknown } | null, link?:
    | { __typename: 'ArticleLinkRecord', id: string, linkText: string, article: { __typename: 'ArticleRecord', slug: string } }
    | { __typename: 'DocumentLinkRecord', id: string, linkText: string, document: { __typename?: 'FileField', filename: string, id: string, url: string } }
    | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
...
type ExternalVideoFragment = { __typename: 'ExternalVideoRecord', id: string, createdAt?: string | null, video: { __typename: 'VideoField', url: string, thumbnailUrl: string, title: string, width: number, height: number } };

type InternalVideoFragment = { __typename: 'InternalVideoRecord', id: string, createdAt?: string | null, video: { __typename: 'VideoFileField', id: string, video: { __typename?: 'UploadVideoField', muxPlaybackId: string, title?: string | null, width: number, height: number, thumbnailUrl: string } } };

type HubspotFormFragment = { __typename: 'HubspotFormRecord', id: string, portalId: string, formId: string, region: string, createdAt?: string | null };
...
type ArticleFragment = { __typename: 'ArticleRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, showInThoughtLeadership?: boolean | null, slug: string, createdAt?: string | null, body: { __typename?: 'ArticleModelBodyField', value: unknown, blocks: Array<
      | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
      | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
          | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
          | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type NewsItemFragment = { __typename: 'NewsItemRecord', id: string, title: string, publication: string, url?: string | null, createdAt?: string | null };

type BookAuthorFragment = { __typename: 'AuthorRecord', id: string, name: string, title: string, bio: { __typename?: 'AuthorModelBioField', value: unknown }, photo: { __typename?: 'FileField', responsiveImage?: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } | null, focalPoint?: { __typename?: 'focalPoint', x: number, y: number } | null } };
...
type FormFragment = { __typename: 'FormRecord', id: string, formName: string, submitButtonText: string, formFields: Array<
    | { __typename: 'FormSelectFieldRecord', id: string, label: string, required?: boolean | null, width: string, options: Array<{ __typename?: 'FormSelectOptionRecord', id: string, value: string }> }
    | { __typename: 'FormTextAreaRecord', id: string, label: string, required?: boolean | null }
    | { __typename: 'FormTextFieldRecord', id: string, label: string, fieldType: string, isInternational?: boolean | null, width: string, required?: boolean | null }
  >, successMessage: { __typename?: 'FormModelSuccessMessageField', value: unknown }, onSubmit: Array<
...
type FormModalFragment = { __typename: 'FormModalRecord', id: string, heading?: string | null, intro?: { __typename?: 'FormModalModelIntroField', value: unknown } | null, form: { __typename: 'FormRecord', id: string, formName: string, submitButtonText: string, formFields: Array<
      | { __typename: 'FormSelectFieldRecord', id: string, label: string, required?: boolean | null, width: string, options: Array<{ __typename?: 'FormSelectOptionRecord', id: string, value: string }> }
      | { __typename: 'FormTextAreaRecord', id: string, label: string, required?: boolean | null }
      | { __typename: 'FormTextFieldRecord', id: string, label: string, fieldType: string, isInternational?: boolean | null, width: string, required?: boolean | null }
    >, successMessage: { __typename?: 'FormModelSuccessMessageField', value: unknown }, onSubmit: Array<
...
type HomeCoachesSectionFragment = { __typename: 'HomeCoachesSectionRecord', id: string, heading?: string | null, body?: { __typename?: 'HomeCoachesSectionModelBodyField', value: unknown } | null, cta?:
    | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
    | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
        | { __typename: 'AdvisorsPageRecord', slug: string }
...
type HomeMarshallFragment = { __typename?: 'HomePageRecord', marshallHeading?: string | null, marshallBody?: { __typename?: 'HomePageModelMarshallBodyField', value: unknown } | null, marshallCta?:
    | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
    | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
        | { __typename: 'AdvisorsPageRecord', slug: string }
...
type HomePromiseFragment = { __typename?: 'HomePageRecord', promiseHeading: string, promiseBody?: { __typename?: 'HomePageModelPromiseBodyField', value: unknown } | null, promiseCta:
    | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
    | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
        | { __typename: 'AdvisorsPageRecord', slug: string }
...
type ThoughtLeadershipItemFragment = { __typename: 'ThoughtLeadershipItemRecord', id: string, heading: string, body?: { __typename?: 'ThoughtLeadershipItemModelBodyField', value: unknown } | null, link?:
    | { __typename: 'ArticleLinkRecord', id: string, linkText: string, article: { __typename: 'ArticleRecord', slug: string } }
    | { __typename: 'DocumentLinkRecord', id: string, linkText: string, document: { __typename?: 'FileField', filename: string, id: string, url: string } }
    | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
...
type NavFragment = { __typename: 'NavRecord', id: string, links: Array<
    | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
    | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
    | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type LeadershipCoursesFragment = { __typename?: 'ThoughtLeadershipPageRecord', coursesHeading: string, coursesImage: { __typename?: 'FileField', url: string, width?: number | null, height?: number | null, format: string, responsiveImage?: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } | null }, coursesDescription: { __typename?: 'ThoughtLeadershipPageModelCoursesDescriptionField', value: unknown }, coursesButton?:
   ...
   | null, coursesCoaches: Array<{ __typename?: 'CoursesCoachRecord', name: string, title: string, image: { __typename?: 'FileField', responsiveImage?: { __typename: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } | null, focalPoint?: { __typename?: 'focalPoint', x: number, y: number } | null } }> };

type ThoughtLeadershipFeaturedItemFragment = { __typename: 'ThoughtLeadershipFeaturedItemRecord', id: string, heading: string, body?: { __typename?: 'ThoughtLeadershipFeaturedItemModelBodyField', value: unknown } | null, link?:
    | { __typename: 'ArticleLinkRecord', id: string, linkText: string, article: { __typename: 'ArticleRecord', slug: string } }
    | { __typename: 'DocumentLinkRecord', id: string, linkText: string, document: { __typename?: 'FileField', filename: string, id: string, url: string } }
    | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
    | { __typename: 'FormLinkRecord', id: string, linkText: string, form: { __typename: 'FormModalRecord', slug: string } }
...
type NewsletterFragment = { __typename: 'NewsletterRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, body: { __typename?: 'NewsletterModelBodyField', value: unknown, blocks: Array<
      | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
      | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
          | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
          | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type VideoFragment = { __typename: 'VideoRecord', id: string, title: string, subtitle?: string | null, ctaText?: string | null, slug: string, createdAt?: string | null, body: { __typename?: 'VideoModelBodyField', value: unknown, blocks: Array<
      | { __typename: 'ArticleAccordionRecord', id: string, title: string, text: { __typename?: 'ArticleAccordionModelTextField', value: unknown } }
      | { __typename: 'ArticleButtonFieldRecord', id: string, buttons: Array<
          | { __typename: 'ExternalLinkRecord', id: string, url: string, linkText: string }
          | { __typename: 'PageLinkRecord', id: string, linkText: string, page:
...
type BioSectionFragment = { __typename: 'BioSectionRecord', id: string, layout: string, colorScheme: string, heading: string, title?: string | null, body: { __typename?: 'BioSectionModelBodyField', value: unknown, blocks: Array<
      | { __typename: 'AccordionRecord', id: string, items: Array<{ __typename: 'AccordionItemRecord', id: string, heading: string, body: { __typename?: 'AccordionItemModelBodyField', value: unknown } }> }
      | { __typename: 'ButtonRecord', id: string, button:
          | { __typename: 'ArticleLinkRecord', id: string, linkText: string, article: { __typename: 'ArticleRecord', slug: string } }
          | { __typename: 'CoachMenuLinkRecord', id: string, linkText: string }
...
type SectionDividerFragment = { __typename: 'SectionDividerRecord', id: string, heading: string };
